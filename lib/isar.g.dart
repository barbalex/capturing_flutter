  ...
  return openIsarInternal(
      ...
      getCollections: (isar) {
        ...
        collections['Store'] = IsarCollectionImpl<Store>(
          ...
          propertyIds: {'id': 0, 'url': 1, 'editingProject': 2},
          indexIds: {},
          linkIds: {},
          backlinkIds: {},
          getId: (obj) => obj.id,
